...
% =========================
% Función Pearson / Cross-correlation normalizada
% =========================
...
% =========================
% Estimar delays con Pearson
% =========================
[d21, cc21, lags21] = pearson_corr(x(2,:), x(1,:));
[d31, cc31, lags31] = pearson_corr(x(3,:), x(1,:));

printf("Delay estimado Pearson mic2-mic1: %d muestras\n", d21);
printf("Delay estimado Pearson mic3-mic1: %d muestras\n", d31);
